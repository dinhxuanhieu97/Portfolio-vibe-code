      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="relative pl-8 border-l border-[var(--color-border)] space-y-12">
          {experiences.map((exp, index) => (
            ...
            >
              {/* Timeline Dot */}
              <div className="absolute -left-[41px] top-0 p-2 rounded-full bg-[var(--color-bg)] border border-[var(--color-border)]">
                <Briefcase size={16} className="text-[var(--color-primary)]" />
              </div>

              <div className="glass-panel p-8 rounded-xl border border-[var(--color-border)]">
